...
test('identity palette resolves by stable ID including reordered registry; independent opt-in',()=>{
 assert.equal(resolveFiveAColorDepth(''),null);assert.equal(resolveFiveAOrbital('?fiveAColorDepth=A'),null);
