# HOME subtle meteor accent candidate

Independent opt-in `homeMeteors=1`; independent from `fiveAColorDepth`.
Status: **READY FOR HUMAN REVIEW**, not HUMAN PASS or HOME visual refreeze.
